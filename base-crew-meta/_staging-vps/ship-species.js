...
const SHIP_SPECIES_SEED = {
  'redrum-raiders': 'goblin',   // founder: keep name + ticker, dynamic NFT sprite = goblin
  'black-tide': 'orc',          // founder 2026-06-26: keep name + ticker, dynamic NFT sprite = orc
  'harbor-guard': 'human',      // founder 2026-06-26: Harbor Guard crew = human
};
