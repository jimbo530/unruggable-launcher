...
///   - Cross-factory referrals: any non-zero upstream address accepted (no isReactor gate)
///   - Validates upstream is a contract (code size > 0) instead of factory registry check
