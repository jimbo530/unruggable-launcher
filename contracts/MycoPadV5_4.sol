...
///   - Launchers can add pools to their own reactors (launcherOf mapping)
///   - addPoolToReactor: owner OR launcher can call
///   - addPoolFromHolding: adds NFT already held by factory to reactor
...
contract Unruggable2 {
    ...
    mapping(address => address) public launcherOf;    // V5.4: reactor -> launcher
    ...
    function launchStep2(
        ...
        launcherOf[reactorAddr] = msg.sender;        // V5.4
        launcherOf[charReactorAddr] = msg.sender;    // V5.4
    ...
    /// @notice Add an LP position NFT to a reactor. Caller must hold the NFT
    ///         and have approved this contract on the position manager.
    ///         Callable by factory owner or the wallet that launched the reactor.
    ...
    /// @notice Add an LP position NFT that is already held by this factory.
    ///         Useful when Wildcard or other contracts send NFTs here directly.
