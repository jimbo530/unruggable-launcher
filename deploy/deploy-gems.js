...
// GEMS — trade-good tokens. D&D gold values; uniform $100M FDV (gold=$0.01) so supply
// scales inversely with value. Diamond 10000g/$100, Ruby/Emerald 1000g/$10, Amethyst
// 100g/$1, Platinum 10g/$0.10.
const COINS = [
  { name: 'Diamond',  symbol: 'DIAMOND',  whole:     1_000_000n }, // $100  ea
  { name: 'Ruby',     symbol: 'RUBY',     whole:    10_000_000n }, // $10   ea
  { name: 'Emerald',  symbol: 'EMERALD',  whole:    10_000_000n }, // $10   ea
  { name: 'Amethyst', symbol: 'AMETHYST', whole:   100_000_000n }, // $1    ea
  { name: 'Platinum', symbol: 'PLATINUM', whole: 1_000_000_000n }, // $0.10 ea
];

const OUT = path.join(__dirname, 'gems-deployed.json');
...
async function main() {
  ...
  const fees = { maxFeePerGas: ethers.parseUnits('3', 'gwei'), maxPriorityFeePerGas: ethers.parseUnits('2', 'gwei') };
