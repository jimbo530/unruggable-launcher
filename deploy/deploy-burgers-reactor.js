...
const TGN_TOKEN        = '0x06a05043eb2c1691b19c2c13219db9212269ddc5';  // BURGERS on Base
...
async function main() {
  ...
  console.log('\n--- Deploying BURGERS Reactor ---');
  console.log('Position Manager:', POSITION_MANAGER);
  console.log('Swap Router:', SWAP_ROUTER);
  console.log('BURGERS Token:', TGN_TOKEN);
