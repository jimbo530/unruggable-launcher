// Wrapper for deploy-shipyard-v2.js — injects env without exposing the key.
// Key from the existing .env (AGENT_PRIVATE_KEY). Public addresses set here.
// Dry-run by default; pass "broadcast" to go live.
...
process.env.PRIZE_WALLET     = '0x799CfafABA99e9779fA8779B56dE62E193cb7B30'; // Vault
process.env.USDC_ADDRESS     = '0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913'; // Base USDC
process.env.CREW_BASE_URI    = process.env.CREW_BASE_URI || 'https://tasern.quest/crew/meta/';
process.env.ETH_USD          = process.env.ETH_USD || '1748';

if (process.argv.includes('broadcast')) process.env.BROADCAST = '1';

require('./deploy-shipyard-v2.js');
