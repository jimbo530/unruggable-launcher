# Unrugable Outreach Target List — First External Users
# Scout Research: May 2026
# Goal: Acquire 5-10 FIRST external launches on Unrugable
...
- Flaunch: Uniswap V4, 30-min fair launch, up to 1% dev revenue per swap. Newer, growing.
- Pump.fun: Solana-only, $600M+ revenue, bonding curve model. No Base presence.
...
**Key Stat for Rug Report Content:**
- Rug pulls cost investors $2.8B in 2025 alone
- 5,000+ new tokens launch daily across chains
- "Lock extension rug" is #1 scam method in 2026
- Locked liquidity is now BASELINE expectation, not differentiator — permanent lock IS the differentiator

---

## TARGET LIST (Ranked by Likelihood to Convert)

### TARGET 1: Farcaster /degen Channel Community
...
- **Platform:** Farcaster + Discord
- **Size:** Active enough for a TGE event (April 2026 snapshot, 10M token airdrop)
- **Why they'd care:** They just did a Token Generation Event and airdrop. Their community understands token mechanics. They may want sub-tokens or spinoff projects. The invite system revenue share aligns with their community-rewards model.
- **Contact approach:** Engage in their Farcaster casts. DM community leads. Position Unrugable as their recommended launch tool for community members who want to create tokens.
- **Pitch angle:** "Your community members want to launch tokens. Give them a safe way to do it — and earn permanent revenue share every time they do. Invite link = passive income for your community treasury."
- **Priority:** HIGH — proven token-launch demand, community infrastructure exists

### TARGET 3: NOICE Token Community (Farcaster Social Token)
- **Platform:** Farcaster
- **Size:** Mid-size but highly engaged Farcaster-native community
- **Why they'd care:** NOICE is a social-native token built around Farcaster's programmable social layer, focusing on tokenized tipping, automated appreciation, and creator monetization. Their community members are creators who might want their own tokens. The invite system maps perfectly to their tipping/appreciation culture.
- **Contact approach:** Engage in their Farcaster channel. Tag community leaders. Frame Unrugable as infrastructure for their creator community.
- **Pitch angle:** "Your creators tip NOICE. But what if each creator could launch their own token — permanently locked, reactor-powered — and YOU earn rev share for every one you onboard? That's our invite system."
- **Priority:** HIGH — creator-monetization aligned, invite system is a natural fit

### TARGET 4: Gnars DAO (Action Sports on Base)
...
- **Platform:** Farcaster + on-chain governance
...
- **Platform:** X/Twitter + Farcaster + Discord
...
- **Platform:** Discord (discord.com/invite/buildonbase)
...
## RUG REPORT CONTENT AMMO

Use these for "Rug Report" social content that drives awareness to Unrugable:

1. **$2.8B lost to rugs in 2025** — "In 2025, rug pulls cost investors $2.8 billion. In 2026, the most common scam is the 'lock extension rug' — they lock LP, build trust, then pull when it expires. Our LP has no expiry. No withdraw function. Period."
...
5. **"Lock extension rug" is #1 scam** — "The #1 rug method in 2026: lock LP for 30 days, build community, wait for unlock, drain. This doesn't work on Unrugable because there IS no unlock. There is no function. The contract literally cannot return LP tokens to anyone."

---

## COMPETITOR INTEL: CLANKER

**Current State (May 2026):**
- Owned by Farcaster (acquired Oct 2025)
- 500K+ tokens launched, $49.8M cumulative fees
- CLANKER token down 85%+ from ATH (now ~$26)
- Listed on HTX (Feb 2026)
- Fee: 1% trading fee (40% creator, 60% Clanker)
- New feature: mention @clanker = deploy (Feb 2026 update)
- Revenue: $400-500K/week in buybacks
- LP: Locked 2100 years (but contract CAN unlock — it's a timelock, not a no-function)

**Clanker Weaknesses to Exploit:**
1. Sniper bots dominate first seconds of every launch
2. 60% of fees go to Clanker, not creator
3. LP is timelocked (2100 years) — not PERMANENTLY locked (the function exists, just delayed)
4. CLANKER token down 85% — community sentiment mixed
5. No promotion included — token launches into silence
6. No network effect — each token is independent, dead tokens stay dead
7. No ongoing trading activity mechanism

**What NOT to Say:**
- Never name Clanker in public content (per compliance checklist)
- Never say "better than" — say what we ARE, not what they aren't
- Never attack Farcaster (they own Clanker now, and we post there)
...
| Target | First Contact | Channel | Response | Launch? | Notes |
|--------|--------------|---------|----------|---------|-------|
| /degen community | | Farcaster | | | |
| HungryDegens | | Farcaster | | | |
| NOICE community | | Farcaster | | | |
| Gnars DAO | | FC + nouns.build | | | |
| Purple DAO | | Farcaster | | | |
| BASED holders | | X + FC + Discord | | | |
| LinksDAO | | Discord | | | |
| /base-builders | | Farcaster | | | |
| Base Discord | | Discord | | | |
| Farcaster DAO NFT | | Farcaster + Zora | | | |
