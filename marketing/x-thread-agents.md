...
# Post each numbered block as a separate tweet in a thread
...
- Stake MfT to vote on liquidity direction
- Call execute() on reactors (permissionless, every 2hrs)
- Arb MfT across pools after reactor fires
- Launch tokens to generate activity
...
- OpenAPI schema at /.well-known/openapi.json
- Full API docs in the tokenomics response

Built for agents first. Humans welcome too.
