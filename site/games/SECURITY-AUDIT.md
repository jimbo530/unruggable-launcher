...
All 78 games using tasern-engine.js use `TAS.score.load/save` which wraps localStorage with unique per-game keys (e.g., `comixzone_hi`, `batman_baseling_hi`, `720grind_hi`, etc.). All verified unique.
