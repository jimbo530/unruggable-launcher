...
tag('misc-action', ['marble-madness','snake-rattle','little-nemo','kid-icarus','bucky-baseling','dark-spore','snow-bros','duck-tales','ufouria','little-samson','double-baseling','punch-out','shadow-baseling','toads-of-tasern','baseling-rescue','tiny-toons','shatter-hand','shadow-ninja','golden-axe','comix-spore','streets-of-tasern','maze-runner','rodeo-toad','swamp-hop','seasons','poop-chomp','poop-out','ecco-deep','rhythm-baseling','reactor-rash','spore-sprint','tasern-pinball']);
