...
tag('puzzle', ['poop-drop','bubble-baseling','lp-lemmings','token-columns','spore-n-ice','rainbow-bridge','reactor-pipes','boulder-baseling','poop-puzznic','kickle-spore','blocks-burg','solomon-key','spore-sphere','ooze-battle']);
...
tag('rpg-adventure', ['legend-of-tasern','tasern-quest','fungi-quest','river-city-brawl','sporegoyle-quest','willow-grove','solstice-tower','startropics-hex','maniac-mansion','pirates-of-tasern','rygar-realm','spore-crystal','whodunit']);
...
tag('misc-action', ['marble-madness','snake-rattle','little-baseling','spore-icarus','bucky-baseling','dark-spore','snow-bros','spore-tales','ufouria','spore-samson','double-baseling','punch-out','shadow-baseling','toads-of-tasern','baseling-rescue','tiny-toons','shatter-hand','shadow-ninja','golden-spore','comix-spore','streets-of-tasern','maze-runner','rodeo-toad','swamp-hop','seasons','poop-chomp','poop-out','baseling-depths','rhythm-baseling','reactor-rash','spore-sprint','tasern-pinball']);
